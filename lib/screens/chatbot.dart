          ...
          children: <Widget>[
            Flexible(
              child: TextField(
                ...
                decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide.none),contentPadding: const EdgeInsets.only(left: 10),hintText: "Send a message"),
              ),
            ),
            Container(
      ...
      Expanded(
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    spreadRadius: 1, color: Colors.grey.withOpacity(0.4), blurRadius: 2)
              ]
          ),
          child: Text(text,
            style: TextStyle(color: Color(0xff1c55d1), fontSize: 14, fontWeight: FontWeight.normal),),
        ),
      ),
    ];
  }
    ...
    return <Widget>[
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.4), blurRadius: 2)]
        ),
        child: CircleAvatar(
          backgroundColor: Colors.white,
          child: Image.asset("assets/images/doc.png", color: Theme.of(context).primaryColor),
        ),
      ),
    ];
  }
